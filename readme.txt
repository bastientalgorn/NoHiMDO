...
Open and run the file "Basic_main.m" with Matlab.
The variable definition is located in the file "Basic_problem_definition.m".
The analysis functions are located in the file "Basic_subsystem_analysis.m"
